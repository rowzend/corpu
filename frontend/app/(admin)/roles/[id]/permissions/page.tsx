        ...
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
                <div className="flex items-center justify-between mb-4">
                    <h3 className="text-sm font-semibold text-gray-900">Filter by Module</h3>
                    ...
                    .map(module => {
                        ...
                        return (
                            <div key={module.id}
                                ...
                                {/* Module Header */}
                                <div className="px-5 py-4 flex items-center justify-between cursor-pointer hover:bg-gray-50/50 transition-colors"
                                        ...
                                        <div className="flex items-center gap-1.5">
                                            <div className="w-20 h-1.5 bg-gray-100 rounded-full overflow-hidden">
                                                <div className={`h-full rounded-full transition-all ${
                                                    allSelected ? 'bg-green-500' : stats.selected > 0 ? 'bg-blue-500' : 'bg-gray-200'
                                                }`}
                                                    style={{ width: `${(stats.selected / stats.total) * 100}%` }} />
                                            </div>
                                            <span className="text-xs text-gray-500 w-14 text-right">{stats.selected}/{stats.total}</span>
                                        </div>
                                                ...
                                                return (
                                                    <label key={rule.id}
                                                        ...
                                                        <div className="min-w-0 flex-1">
                                                            ...
                                                            <div className="text-[11px] text-gray-400 font-mono mt-1 bg-gray-50 px-2 py-0.5 rounded inline-block">
            ...
            {/* Bottom Save */}
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5 flex items-center justify-between sticky bottom-4">
                <div className="text-sm text-gray-500">
                    <span className="font-semibold text-gray-900">{selectedRuleIds.size}</span> of {allRules.length} permissions selected
                </div>
                <div className="flex gap-2">
                    <button onClick={() => router.push(`/roles/${roleId}`)}
                        className="px-5 py-2.5 border border-gray-200 rounded-xl font-medium text-sm text-gray-700 hover:bg-gray-50 transition-colors">
                        Cancel
                    </button>
                    <button onClick={handleSave} disabled={isSaving}
