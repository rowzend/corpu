                        ...
                        <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2">
                                <span className={`font-medium truncate ${
                                    level === 0 ? 'text-gray-900' : 'text-gray-800'
                                }`}>
                                    {category.name}
                                </span>
                                ...
                                {!category.is_active && (
                                    <Badge className="bg-gray-200 text-gray-600 text-xs border-0">
                                        Inactive
                                    </Badge>
                                )}
                            </div>
                ...
                <div className="relative z-10">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <div>
                                <h1 className="text-2xl font-bold text-white">Kategori Knowledge Base</h1>
                                <p className="text-violet-100 text-sm">Kelola kategori dan sub-kategori artikel</p>
                            </div>
                        </div>
                        <button
                            onClick={() => router.push('/knowledge/categories/create')}
                            className="inline-flex items-center gap-2 bg-white text-violet-700 hover:bg-violet-50 px-5 py-2.5 rounded-xl font-semibold transition-all shadow-lg hover:shadow-xl"
                        >
                    ...
                    <div className="grid grid-cols-3 gap-4 mt-6">
                        {[
                            { label: 'Total Kategori', value: categories.length, icon: FolderTree, color: 'bg-violet-400/20 text-violet-200' },
