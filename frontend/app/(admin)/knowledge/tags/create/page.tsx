        ...
        <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-orange-600 via-orange-700 to-red-800 p-6">
                ...
                <div className="relative z-10 flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-xl font-bold text-white">Tambah Tag</h1>
                        <p className="text-orange-100 text-sm">Buat tag baru untuk knowledge base</p>
                    </div>
                </div>
            </div>
                        ...
                        <div className="flex gap-4 pt-4">
                            ...
                            >
                                {loading ? (
                                    ...
                                    <><Save className="w-4 h-4" /> Simpan Tag</>
                                )}
                            </button>
