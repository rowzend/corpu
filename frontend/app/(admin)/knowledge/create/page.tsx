            ...
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-emerald-600 via-emerald-700 to-teal-800 p-6">
                ...
                <div className="relative z-10 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-xl font-bold text-white">Tambah Artikel</h1>
                            <p className="text-emerald-100 text-sm">Buat artikel baru untuk knowledge base</p>
                        </div>
                    </div>
                            ...
                            <div className="p-6 space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <Input
                                            id="slug"
                                            value={`/knowledge/[auto-generated-from-title]`}
                                            readOnly
