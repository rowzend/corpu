    ...
    if (loading) {
        return (
            <div className="space-y-6">
                ...
                <div className="space-y-3">{[1, 2, 3, 4].map(i => <div key={i} className="h-20 bg-gray-200 rounded-xl animate-pulse"></div>)}</div>
            </div>
        );
    }
            ...
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-amber-600 via-amber-700 to-orange-800 p-8">
                ...
                <div className="relative z-10">
                    <div className="flex items-center justify-between">
                        ...
                        <button onClick={() => router.push('/learning/enrollments/create')}
                            className="inline-flex items-center gap-2 bg-white text-amber-700 hover:bg-amber-50 px-5 py-2.5 rounded-xl font-semibold transition-all shadow-lg hover:shadow-xl">
                ...
                <div className="flex flex-col md:flex-row gap-4">
                    ...
                    <div className="flex gap-2 items-center">
                        ...
                        <select value={statusFilter} onChange={(e) => setStatusFilter(e.target.value)}
                            className="px-3 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 bg-gray-50 text-sm">
            ...
            {filtered.length > 0 ? (
                <div className="grid gap-3">
                    {filtered.map((enrollment) => (
                        <div key={enrollment.id} className="bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-md hover:border-amber-100 transition-all">
                            <div className="p-4">
                                <div className="flex items-center justify-between gap-4">
                                    ...
                                    <div className="flex items-center gap-4 flex-shrink-0">
                                        ...
                                        <select value={enrollment.status}
                                            ...
                                            className="px-2 py-1.5 text-xs border border-gray-200 rounded-lg bg-gray-50 text-gray-700 focus:ring-2 focus:ring-amber-500">
                                            <option value="active">Aktif</option>
                                            <option value="completed">Selesai</option>
                                            <option value="dropped">Berhenti</option>
                                        </select>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-12 text-center">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">Belum ada enrollment</h3>
                    <p className="text-gray-500 mb-6">Daftarkan siswa ke kursus secara manual</p>
                    <button onClick={() => router.push('/learning/enrollments/create')}
