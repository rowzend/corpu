...
export default function TemplatePage() {
    ...
    const renderImgUpload = (label: string, preview: string | null, file: File | null, setFile: any, setPreview: any, setRemove: any, ref: any, remove: boolean) => (
        <div>
            ...
            <div className="mt-1.5 flex items-start gap-3">
                <div className="w-20 h-20 border border-gray-200 rounded-xl overflow-hidden bg-gray-50 flex items-center justify-center shrink-0">
                    {preview && !remove ? <img src={preview} alt="" className="w-full h-full object-contain" /> : <ImageIcon className="w-6 h-6 text-gray-300" />}
                </div>
                <div className="space-y-1.5">
                    ...
                    <button type="button" onClick={() => ref.current?.click()}
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm text-gray-700 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors">
                    ...
                    {(preview || file) && !remove && (
                        <button type="button" onClick={() => handleRemoveFile(setFile, setPreview as any, setRemove, ref)}
                            className="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm text-red-600 bg-white border border-red-200 rounded-xl hover:bg-red-50 transition-colors ml-1">
    ...
    const inputCls = "border-gray-200 focus:border-violet-500 focus:ring-violet-500";
    const selectCls = "w-full px-3 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-violet-500 focus:border-violet-500 bg-gray-50 text-sm";
        ...
        <div className="space-y-6">
            ...
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-violet-600 via-violet-700 to-purple-800 p-6">
                ...
                <div className="relative z-10 flex items-center gap-3">
                    <button onClick={() => router.push('/learning/certificates/user')}
                    ...
                    return (
                        <button key={t.key} onClick={() => setTab(t.key)}
                            className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium transition-all flex-1 justify-center ${
                                isActive ? 'bg-gradient-to-r from-violet-600 to-purple-700 text-white shadow-md' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-50'
                            }`}>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100">
                        <div className="px-6 py-4 border-b border-gray-100">
                            <div className="flex items-center gap-2">
                                ...
                                <h2 className="text-lg font-semibold text-gray-900">Penandatangan</h2>
                            </div>
                        </div>
                        <div className="p-6">
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100">
                        <div className="p-6">
                            <label className="flex items-center gap-3 cursor-pointer">
                                ...
                                <span className="text-sm text-gray-700">Tampilkan durasi kursus (jam pelajaran) di sertifikat</span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100">
                        <div className="px-6 py-4 border-b border-gray-100">
                            <div className="flex items-center gap-2">
                                ...
                                <h2 className="text-lg font-semibold text-gray-900">Format Nomor Sertifikat</h2>
                            </div>
                        </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100">
                    <div className="px-6 py-4 border-b border-gray-100">
                        <div className="flex items-center gap-2">
                            ...
                            <h2 className="text-lg font-semibold text-gray-900">Template Per Kursus</h2>
                        </div>
                    </div>
                    <div className="p-6">
                        ...
                        {courses.length === 0 ? (
                            <p className="text-sm text-gray-500 text-center py-8">Belum ada kursus. Buat kursus dulu.</p>
                        ) : (
                                        ...
                                        <div key={course.id} className="border border-gray-200 rounded-xl overflow-hidden">
                                            <div className="flex items-center justify-between px-5 py-3.5 cursor-pointer hover:bg-gray-50 transition-colors"
                                                ...
                                                <div className="flex gap-1.5 text-xs">
                                                    ...
                                                    {course.certificate_background && <Badge variant="outline" className="border-gray-200">BG</Badge>}
                                                    {(course.cert_institution_name || course.cert_signature_name) && <Badge variant="outline" className="border-gray-200">Custom</Badge>}
                                            ...
                                            {expanded && (
                                                <div className="border-t border-gray-100 px-5 py-4">
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                                                        <div className="space-y-1.5">
                                                            <Label className="text-xs font-medium text-gray-600">Nama Institusi</Label>
                                                        ...
                                                        <div className="space-y-1.5">
                                                            <Label className="text-xs font-medium text-gray-600">Tampilkan Durasi</Label>
                                                        ...
                                                        <div className="space-y-1.5">
                                                            <Label className="text-xs font-medium text-gray-600">Format Nomor</Label>
                                                            <Input className={`text-sm ${inputCls}`} value={ov('cert_number_format')}
                                                                onChange={(e) => setOv('cert_number_format', e.target.value)}
                                                                placeholder="Kosongkan → pakai global" />
                                                            <p className="text-xs text-gray-400">Variable: {'{PREFIX}'}, {'{DATE}'}, {'{RANDOM}'}, {'{YEAR}'}, {'{MONTH}'}, {'{DAY}'}, {'{COURSE_ID}'}, {'{USER_ID}'}</p>
                                                        </div>
                                                        <div className="space-y-1.5">
                                                            <Label className="text-xs font-medium text-gray-600">Logo (gambar)</Label>
                                                            <div className="flex items-center gap-2">
                                                                <label className="flex-1 flex items-center gap-2 px-3 py-2 border border-gray-200 rounded-xl cursor-pointer hover:bg-gray-50 transition-colors text-sm text-gray-500">
                                                        ...
                                                        <div className="space-y-1.5">
                                                            <Label className="text-xs font-medium text-gray-600">Tanda Tangan (gambar)</Label>
                                                            <label className="flex items-center gap-2 px-3 py-2 border border-gray-200 rounded-xl cursor-pointer hover:bg-gray-50 transition-colors text-sm text-gray-500">
                                                        ...
                                                        <div className="space-y-1.5">
                                                            <Label className="text-xs font-medium text-gray-600">Background (gambar)</Label>
                                                            <label className="flex items-center gap-2 px-3 py-2 border border-gray-200 rounded-xl cursor-pointer hover:bg-gray-50 transition-colors text-sm text-gray-500">
                                                        ...
                                                        <div className="space-y-1.5">
                                                            <Label className="text-xs font-medium text-gray-600">Template HTML</Label>
                                                            <label className="flex items-center gap-2 px-3 py-2 border border-gray-200 rounded-xl cursor-pointer hover:bg-gray-50 transition-colors text-sm text-gray-500">
                                                    ...
                                                    <div className="border-t border-gray-100 pt-4 mt-4">
                                                        <div className="flex items-center gap-1.5 mb-2">
                                                            ...
                                                            <span className="text-xs font-medium text-gray-600">TTE Khusus Course</span>
                                                        </div>
                                                        {course.cert_tte_enabled && course.cert_tte_created_at ? (
                                                            ...
                                                            <p className="text-xs text-gray-400 mb-2">Gunakan TTE global atau buat khusus untuk course ini</p>
                                                        )}
                                                        <div className="flex gap-2">
                                                            ...
                                                            <button disabled={!('_ttePw' in (courseTmplFiles[course.id] || {}))}
                                                                ...
                                                                className="inline-flex items-center gap-1.5 px-4 py-2.5 text-sm font-medium text-gray-700 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors disabled:opacity-50">
            ...
            {tab === 'tte' && (
                <div className="bg-white rounded-xl shadow-sm border border-gray-100">
                    <div className="px-6 py-4 border-b border-gray-100">
                        <div className="flex items-center gap-2">
                            {tteHasCert ? <ShieldCheck className="w-5 h-5 text-green-500" /> : <ShieldAlert className="w-5 h-5 text-gray-400" />}
                            <h2 className="text-lg font-semibold text-gray-900">Tanda Tangan Elektronik</h2>
                        </div>
                    </div>
                    <div className="p-6 space-y-5">
                        {tteHasCert ? (
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex gap-2">
                                ...
                                <button disabled={!ttePassphrase || tteGenerating} onClick={handleGenerateTte}
                                    className="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-medium text-gray-700 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors disabled:opacity-50">
                                    {tteGenerating ? <Loader className="w-4 h-4 animate-spin" /> : <KeyRound className="w-4 h-4" />} Generate
                                </button>
                            </div>
                            <p className="text-xs text-gray-400">Passphrase melindungi kunci privat. Simpan dengan aman.</p>
                        </div>
                    </div>
                </div>
            )}
                ...
                <div className="space-y-4">
                            ...
                            <div className="flex-1">
                                ...
                                <div className="relative">
                                    ...
                                    <input type="text" placeholder="Nama, kursus, nomor..." value={certSearch}
                                        ...
                                        className="w-full pl-9 pr-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-violet-500 focus:border-violet-500 bg-gray-50 focus:bg-white transition-colors text-sm" />
                                </div>
                            </div>
                            <div>
                                <Label className="text-xs font-medium text-gray-600 mb-1 block">Status</Label>
                                <select value={actFilter} onChange={e => setActFilter(e.target.value)}
                                    className="px-4 py-2.5 border border-gray-200 rounded-xl bg-gray-50 text-sm focus:ring-2 focus:ring-violet-500 focus:border-violet-500">
                    ...
                    {filteredCerts.length === 0 ? (
                        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-12 text-center">
                            ...
                            <p className="font-medium text-gray-900">Tidak ada sertifikat</p>
                            <p className="text-gray-500 text-sm mt-1">Sertifikat akan muncul setelah ada yang diterbitkan</p>
                        </div>
                    ) : (
                        <div className="space-y-2">
                            {filteredCerts.map(cert => (
                                <div key={cert.id}
                                    className={`bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-all ${!cert.is_active ? 'opacity-60' : ''}`}>
                                    <div className="p-4 flex items-center justify-between gap-4">
                                        <div className="flex items-start gap-3 flex-1 min-w-0">
                                            <div className={`w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0 ${cert.is_active ? 'bg-amber-100' : 'bg-gray-100'}`}>
                                                <Award className={`w-5 h-5 ${cert.is_active ? 'text-amber-600' : 'text-gray-400'}`} />
                                            </div>
                                            <div className="min-w-0">
                                                <p className="text-sm font-medium text-gray-900 truncate">{cert.user_name}</p>
                                                <p className="text-xs text-gray-500 truncate">{cert.course_title}</p>
                                                <p className="text-xs text-gray-400 mt-0.5">{cert.certificate_number} &middot; {new Date(cert.issued_at).toLocaleDateString('id-ID')}</p>
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-1.5 flex-shrink-0">
                                            <Badge className={cert.is_active ? 'bg-green-100 text-green-700 border-0' : 'bg-gray-100 text-gray-500 border-0'}>
                                                {cert.is_active ? 'Aktif' : 'Nonaktif'}
                                            </Badge>
                                            <button onClick={() => handleDownloadCert(cert.id)}
                                                className="p-2 text-gray-400 hover:text-violet-600 hover:bg-violet-50 rounded-lg transition-colors" title="Download">
                                            ...
                                            <button onClick={() => handleToggleCert(cert.id)}
                                                ...
                                                {cert.is_active ? <ToggleRight className="w-4 h-4 text-green-600" /> : <ToggleLeft className="w-4 h-4 text-gray-400" />}
                                            </button>
