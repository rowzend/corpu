        ...
        return (
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-3 gap-6">
                    {[1, 2, 3].map(i => <div key={i} className="h-44 bg-gray-200 rounded-xl animate-pulse"></div>)}
                </div>
            </div>
        );
    }
            ...
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-pink-600 via-pink-700 to-rose-800 p-6">
                ...
                <div className="relative z-10 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <button onClick={() => router.push('/learning/quizzes')}
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100">
                    ...
                    <div className="p-6 space-y-3">
                        <button onClick={() => router.push(`/learning/quizzes/${quizId}/questions`)}
                            className="w-full flex items-center gap-3 px-4 py-3 text-sm font-medium text-gray-700 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
