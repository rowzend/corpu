        ...
        return (
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-3 gap-6">
                    {[1, 2, 3].map(i => <div key={i} className="h-36 bg-muted rounded-xl animate-pulse"></div>)}
                </div>
            </div>
        );
    }
        ...
        <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-teal-600 via-teal-700 to-cyan-800 p-6">
                ...
                <div className="relative z-10 flex items-center gap-3">
                    <button onClick={() => router.push('/admin/learning/progress')}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-card rounded-xl shadow-sm border border-border">
                    <div className="px-6 py-4 border-b border-border flex items-center gap-2">
                        ...
                        <h2 className="text-lg font-semibold text-card-foreground">Informasi</h2>
                    </div>
                ...
                <div className="bg-card rounded-xl shadow-sm border border-border">
                    <div className="px-6 py-4 border-b border-border flex items-center gap-2">
                        ...
                        <h2 className="text-lg font-semibold text-card-foreground">Sertifikat</h2>
                    </div>
                    <div className="p-6 space-y-4">
                        <div className="flex justify-between py-2">
                            <span className="text-sm text-muted-foreground">Status</span>
