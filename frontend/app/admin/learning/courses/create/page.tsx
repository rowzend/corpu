                    ...
                    <div className="p-6 space-y-5">
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="slug" className="text-sm font-medium text-card-foreground flex items-center gap-2">
                                    URL Slug
                                    <span className="text-xs text-amber-600 bg-amber-50 dark:bg-amber-900/30 px-2 py-0.5 rounded">Akan dibuat otomatis</span>
                                </Label>
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea id="short_description" name="short_description" placeholder="Deskripsi singkat kursus (opsional)"
                                ...
                                className="w-full px-3 py-2.5 border border-border rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 bg-muted focus:bg-card transition-colors text-sm"
                                rows={2} />
                        </div>
                        <div className="space-y-2">
                            ...
                            <div className="[&_.ql-editor]:min-h-[300px] [&_.ql-toolbar]:rounded-t-xl [&_.ql-container]:rounded-b-xl [&_.ql-container]:border-border [&_.ql-toolbar]:border-border">
                                <ReactQuill
