        ...
        <div className="p-6 space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                    ...
                    <p className="text-card-foreground mt-1">Kelola pertanyaan quiz</p>
                </div>
                ...
                {quiz.questions?.length === 0 && (
                    <Card>
                        <CardContent className="p-12 text-center">
                            <p className="text-card-foreground">Belum ada pertanyaan. Klik "Tambah Soal" untuk mulai.</p>
                        </CardContent>
                    </Card>
                )}
                            ...
                            <CardContent>
                                <div className="space-y-2">
                                    {q.choices.map((c: any, cIndex: number) => (
                                        <div key={c.id} className={`flex items-center gap-2 p-2 rounded ${c.is_correct ? 'bg-green-50 border border-green-200' : 'bg-muted '}`}>
                ...
                <DialogContent className="max-w-2xl">
                    ...
                    <div className="space-y-4">
                        ...
                        {formData.question_type === 'true_false' && (
                            <p className="text-sm text-muted-foreground">Tandai pilihan "Benar" sebagai jawaban yang tepat.</p>
                        )}
