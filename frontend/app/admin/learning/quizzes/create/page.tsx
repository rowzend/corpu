        ...
        <div className="p-6 space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-card-foreground mt-1">Buat quiz dan tambahkan pertanyaan</p>
                </div>
            </div>
                        ...
                        {formData.questions.map((q, qIndex) => (
                            <div key={qIndex} className="border rounded-lg p-4 space-y-3">
                                ...
                                {q.question_type === 'true_false' && (
                                    <p className="text-sm text-muted-foreground">Jawaban benar/salah akan diatur otomatis</p>
                                )}

                                {q.question_type === 'essay' && (
                                    <p className="text-sm text-muted-foreground">Jawaban esai akan dinilai manual</p>
                                )}
                            </div>
                        ))}
                    </CardContent>
