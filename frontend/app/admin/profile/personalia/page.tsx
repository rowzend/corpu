...
export default function PersonaliaPage() {
    ...
    const handleSubmit = async () => {
        if (!form.name.trim() || !form.position.trim()) {
            showError(t('name_position_required'));
            return;
        }
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" value={form.position} onChange={e => setForm(f => ({ ...f, position: e.target.value }))}
                                                className="w-full px-4 py-2.5 border border-border rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 bg-muted focus:bg-card transition-colors text-sm" placeholder={t('position_placeholder')} />
                                        </div>
                                    </div>
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                        ...
                        <div key={item.id}
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div className="flex-1 min-w-0 grid grid-cols-1 md:grid-cols-4 gap-2 md:gap-4">
                                    ...
                                    <div className="md:col-span-1">
                                        <p className="text-sm text-card-foreground truncate">{item.position}</p>
