        ...
        return (
            <div className="flex items-center justify-center py-24">
                <div className="text-center">
                    ...
                    <h2 className="text-xl font-semibold text-card-foreground mb-2">Error Loading Role</h2>
        ...
        <div className="space-y-6">
            ...
            <div className="bg-card rounded-xl shadow-sm border border-border">
                <div className="px-6 py-4 border-b border-border flex items-center justify-between">
                    <h2 className="text-lg font-semibold text-card-foreground">Role Information</h2>
                    {!isEditing && (
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            {[
                                ...
                                <div key={i}>
                                    ...
                                    <p className="text-base font-semibold text-card-foreground">{field.value}</p>
                                </div>
                            ))}
                        </div>
                    )}
                        ...
                        <div className="space-y-2">
                            {role.permissions.map((permission) => (
                                <div key={permission.id}
                                    className="flex items-center justify-between p-3 border border-border rounded-xl hover:bg-muted hover:bg-muted hover:border-blue-100 transition-all">
                                    <div className="flex items-start gap-3 min-w-0">
                                        ...
                                        <div className="min-w-0">
                                            ...
                                            <div className="text-xs text-muted-foreground font-mono mt-1 bg-muted px-2 py-0.5 rounded inline-block">
