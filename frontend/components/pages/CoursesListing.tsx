          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-3 gap-6 max-w-2xl mx-auto">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                ...
                <div className="text-sm text-blue-100">{t('courses_page.stats_courses')}</div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                <div className="text-3xl font-bold">{courses.reduce((s, c) => s + (c.enrolled_count || 0), 0)}+</div>
                <div className="text-sm text-blue-100">{t('courses_page.stats_participants')}</div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                ...
                <div className="text-sm text-blue-100">{t('courses_page.stats_rating')}</div>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="mb-6">
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-2.5 pl-10 text-sm border border-border rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-muted"
                  />
                ...
                <div className="space-y-2">
                  {['all', 'beginner', 'intermediate', 'advanced'].map((level) => (
                    <label key={level} className="flex items-center cursor-pointer group">
                      ...
                      />
                      <span className="ml-2 text-sm text-foreground group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                        {levelLabels[level]}
                      </span>
                    </label>
                  ))}
                ...
                <div className="space-y-2 max-h-64 overflow-y-auto pr-2">
                  <label className="flex items-center cursor-pointer group">
                    <input
                      ...
                      className="w-4 h-4 text-blue-600 dark:text-blue-400 focus:ring-blue-500"
                    />
                    <span className="ml-2 text-sm text-foreground group-hover:text-blue-600 dark:group-hover:text-blue-400">{t('courses_page.all_categories')}</span>
                  </label>
                  {categories.map((cat) => (
                    <label key={cat} className="flex items-center cursor-pointer group">
                      <input
                        ...
                        className="w-4 h-4 text-blue-600 dark:text-blue-400 focus:ring-blue-500"
                      />
                      <span className="ml-2 text-sm text-foreground group-hover:text-blue-600 dark:group-hover:text-blue-400">{cat}</span>
                    </label>
                  ))}
                </div>
              </div>
                ...
                <div className="space-y-2">
                  <label className="flex items-center cursor-pointer group">
                    <input
                      ...
                      className="w-4 h-4 text-blue-600 dark:text-blue-400 focus:ring-blue-500"
                    />
                    <span className="ml-2 text-foreground group-hover:text-blue-600 dark:group-hover:text-blue-400">{t('courses_page.all')}</span>
                  </label>
                  {[5, 4, 3].map((rating) => (
                    <label key={rating} className="flex items-center cursor-pointer group">
                      <input
                        ...
                        className="w-4 h-4 text-blue-600 dark:text-blue-400 focus:ring-blue-500"
                      />
                      <span className="ml-2 flex items-center text-foreground group-hover:text-blue-600 dark:group-hover:text-blue-400">
          ...
          <div className="flex-1">
            <div className="mb-8 flex items-center justify-between">
              <div>
                ...
                <p className="text-muted-foreground">{t('courses_page.showing')} <span className="font-semibold text-blue-600 dark:text-blue-400">{filteredCourses.length}</span> {t('courses_page.courses_count')}</p>
              </div>
              <div className="flex items-center gap-3">
                <div className="flex items-center gap-2">
                  ...
                  <select
                    ...
                    className="px-3 py-2 border border-border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-card text-foreground text-sm"
                  >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <select className="px-3 py-2 border border-border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-card text-foreground text-sm">
              ...
              {paginatedCourses.map((course, index) => (
                ...
                >
                  <div className="flex flex-col md:flex-row">
                    {/* Thumbnail */}
                    <div className="md:w-80 h-64 md:h-auto bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-9xl flex-shrink-0 relative overflow-hidden">
                      {course.thumbnail ? (
                      ...
                      <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-semibold text-blue-600 dark:text-blue-400">
                    ...
                    <div className="flex-1 p-6 md:p-8 flex flex-col justify-between">
                      <div>
                        ...
                        <h3 className="text-2xl font-bold text-card-foreground mb-3 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                          {course.title}
                        </h3>
                      ...
                      <div className="flex items-center justify-between pt-4 border-t border-border">
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <button className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-xl font-semibold transition-all duration-300 hover:shadow-lg flex items-center gap-2">
