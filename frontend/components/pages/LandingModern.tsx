        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 xl:gap-20 items-center">
            ...
            <div className="space-y-6 lg:pr-8 max-w-2xl">
              {/* Badge */}
              <div className="inline-flex items-center gap-2 bg-green-500/15 backdrop-blur-sm border border-green-500/30 rounded-full px-4 py-2 text-sm text-green-700 dark:text-green-300 font-medium">
              ...
              <div className="pt-2 flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <span className="font-medium">
                  <strong className="text-accent">10.000+</strong> ASN telah bergabung dan belajar bersama kami
                </span>
              </div>
            </div>
