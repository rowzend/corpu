      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">{appDesc}</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/hcdp" className="hover:text-white transition-colors">HCDP</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="flex space-x-4 mt-4">
              {socialLinks.map(({ key }) => {
                ...
                if (!url) return null;
                return (
                  <a key={key} href={url} target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                    {key === 'social_facebook' && (
